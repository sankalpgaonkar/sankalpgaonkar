...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&reversal=true&text=Sankalp%20Gaonkar&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=AI%20%26%20Data%20Science%20%7C%20Full-Stack%20Dev%20%7C%20IoT%20Builder&descAlignY=55&descSize=16" />
...
class SankalpGaonkar:
    ...
    def fun_facts(self):
        return [
            "🏆 Former Sports Team Captain & State-level Qualifier",
            "🎵 Singer, Dancer & Actor off the clock",
            "🗣️ Public Speaker & Indian Mythology enthusiast",
        ]
```
...
|:---|:---|
| ML model analyzing environmental factors (temperature, humidity, light) to predict poultry egg yields with high accuracy. | IoT-based assistive device using ultrasonic sensors and AI to enhance mobility and safety for visually impaired individuals. |
| `Python` `Scikit-learn` `Pandas` `Matplotlib` | `Arduino` `IoT` `Ultrasonic Sensors` `Embedded C` |
...
|:---|:---|
| A fun recreation of the classic Flappy Bird game built from scratch using vanilla web technologies. | Currently building exciting AI & Full-Stack projects. Stay tuned! |
| `JavaScript` `HTML5 Canvas` `CSS3` | `AI` `Web Dev` `IoT` |
...
| ☁️ **Azure Cloud Computing** | Specialization in cloud infrastructure & deployment |
| 🏢 **Salesforce Workshop Coordinator** | Organized & led technical workshops on Salesforce CRM |
| 🏆 **State-Level Sports Qualifier** | Former Sports Team Captain — leadership under pressure |
| 🎤 **Public Speaker & Anchor** | Event coordination, anchoring & audience engagement |
...
[![Facebook](https://img.shields.io/badge/Facebook-1877F2?style=for-the-badge&logo=facebook&logoColor=white)](https://facebook.com/SankalpGaonkar)
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:sankalpgaonkar@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/sankalpgaonkar)
